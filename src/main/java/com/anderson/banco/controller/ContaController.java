...
public class ContaController {
	...
	public ResponseEntity<ContaModelResponse> getConta(@ApiParam(value = "UUID da conta que será consultado", required = true) @PathVariable String uuid){
	...
	public ResponseEntity<ContaModelResponse> criarConta(@ApiParam(value = "Objeto conta que será cadastrada no banco", required = true) @Valid @RequestBody ContaModelRequest contaModelRequest, BindingResult erroRequest){
	...
	public ResponseEntity<ContaModelResponse> depositarDinheiro(@ApiParam(value = "UUID da conta que vai depositar", required = true) @PathVariable String uuid, @ApiParam(value = "Valor para fazer a operação de deposito", required = true) @RequestParam(value = "valor") BigDecimal valor){
	...
	public ResponseEntity<ContaModelResponse> sacarDinheiro(@ApiParam(value = "UUID da conta que vai sacar", required = true) @PathVariable String uuid, @ApiParam(value = "Valor para fazer a operação de saque", required = true) @RequestParam(value = "valor") BigDecimal valor){
	...
	public ResponseEntity<ContaModelResponse> transferir(@ApiParam(value = "UUID da conta que vai fazer a transferência", required = true) @PathVariable(value = "uuidRetira") String uuidRetira, @ApiParam(value = "UUID da conta que vai receber a transferência", required = true) @RequestParam(value = "uuidRecebe") String uuidRecebe, @ApiParam(value = "Valor para fazer a operação de transferência", required = true) @RequestParam(value = "valor") BigDecimal valor){
	...
	public ResponseEntity<Object> deletarConta(@ApiParam(value = "UUID da conta que será deletada", required = true) @PathVariable String uuid){
	...
	public ResponseEntity<CompraModelResponse> criarCompra(@ApiParam(value = "UUID da conta que vai comprar", required = true) @PathVariable String uuid, @ApiParam(value = "Objeto compra que vai ser cadastrado na conta informada", required = true) @Valid @RequestBody CompraModelRequest compraModelRequest, BindingResult erroRequest){
		if(erroRequest.hasErrors()) throw new RequestConstraintException(erroRequest.getAllErrors().get(0).getDefaultMessage());
	...
	public ResponseEntity<List<CompraModelResponse>> getCompras(@ApiParam(value = "UUID da conta que possui as compras", required = true) @PathVariable String uuid){
	...
	public ResponseEntity<CompraModelResponse> getCompra(@ApiParam(value = "UUID da conta que possui a compra", required = true) @PathVariable(value = "uuid") String uuid, @ApiParam(value = "ID da compra que será exibida", required = true) @PathVariable(value = "id_compra") int id_compra){
