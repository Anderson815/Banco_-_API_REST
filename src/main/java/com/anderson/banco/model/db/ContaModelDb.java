...
public class ContaModelDb {
	...
	private List<CompraModelDb> compras;
	...
	public List<CompraModelDb> getCompras() {
		return compras;
	}
	public void setCompras(List<CompraModelDb> compraModelRespons) {
		this.compras = compraModelRespons;
	}
}
